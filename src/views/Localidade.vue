    ...
    <div class="localidade">
        ...
        <div class="btns">
            <router-link to="/ondeencontrar">
                <v-btn value="AM" color="blue lighten-4">
                    <span>Manaus</span>
                </v-btn>
            </router-link>

            <router-link to="/macapa">
                <v-btn value="AP" color="blue lighten-4">
                    <span>Macapa</span>
                </v-btn>
            </router-link>

            <router-link to="/riobranco">
                <v-btn value="AC" color="blue lighten-4" >
